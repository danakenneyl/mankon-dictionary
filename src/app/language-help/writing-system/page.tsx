  ...
  return (
        <div className="content-wrapper">
          ...
          <section>
            ...
            <p>
              The General Alphabet of Cameroon Languages (GACL) was developed to standardize writing across a diverse range of Cameroonian languages in 1979. It is used primarily in Bible translations for Mankon.
              GACL uses the same 9 vowels used in the Mankon Alphabet, but primarily represents consonants using letters from the English Alphabet. The one exception is the use of the engma (ŋ) character 
              (English represents this sound with the sequence &apos;ng&apos;).
            </p>
